...
class Solver:
    ...
    def solve(self) -> bool:
        ...
        for entry_point in self.entry_points:
            ...
            agent = Agent(0, 1, 0, 0, len(self.labyrinth[0]) - 1, len(self.labyrinth) - 1)
            print(agent.y)
            print(agent.path)
            agent.move(1, -1, 0, 0)
            print(agent.y)
            ...
            exit_point_found = agent.found_exit_point(self.labyrinth[agent.y][agent.x])

            #while not exit_point_found:
